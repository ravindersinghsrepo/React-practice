import RestaurantCard, { withNearbyLabel } from "./RestaurantCard";
...
const Body = () =>{
    ...
    const RestaurantCardNearby = withNearbyLabel(RestaurantCard);
        ...
        <div className="flex flex-wrap">
          {
            filteredlist.map((restaurant)=>(
              ...
              >
              {
                ...
                :
                (
                <RestaurantCardNearby resData={restaurant} />
                )
              }
              </Link>
            ))
